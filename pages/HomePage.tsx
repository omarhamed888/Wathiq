    ...
    <Card className="hover:shadow-xl transition-shadow duration-300">
        <CardContent className="p-6">
            <div className="flex items-center justify-between">
                ...
                {trend && <span className="text-sm font-medium text-green-600 dark:text-green-400 flex items-center"><TrendingUp className="w-4 h-4 mr-1"/>{trend}</span>}
            </div>
            <div className="mt-4">
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-full bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-200">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-slate-100 via-blue-100 to-teal-100 dark:from-slate-900 dark:via-blue-950 dark:to-teal-950 text-black dark:text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32 text-center">
          ...
          <motion.div {...{ initial: { opacity: 0, y: 30 }, animate: { opacity: 1, y: 0 }, transition: { duration: 0.8 } }}>
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-blue-200 text-blue-900 hover:bg-blue-300 dark:bg-blue-500/80 dark:text-white dark:hover:bg-blue-500 shadow-lg hover:shadow-xl transition-all duration-300" asChild>
                <Link to="/scanner">
      ...
      <section className="py-16 -mt-16 relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <StatsCard title="Avg. Trust Score" value={`${stats.averageTrustScore}%`} icon={Shield} color="text-green-600" bgColor="bg-green-100 dark:bg-green-900/50" trend="+5%"/>
                <StatsCard title="Total Scans" value={stats.totalScans} icon={Scan} color="text-blue-600" bgColor="bg-blue-100 dark:bg-blue-900/50" />
                <StatsCard title="Level" value={user.level} icon={Award} color="text-purple-600" bgColor="bg-purple-100 dark:bg-purple-900/50" />
                <StatsCard title="Points" value={user.total_points} icon={Zap} color="text-yellow-600" bgColor="bg-yellow-100 dark:bg-yellow-900/50" />
            </div>
        </div>
      </section>
      ...
      {recentScans.length > 0 && (
        <section className="pb-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-8 text-center">Recent Activity</h2>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-50 to-teal-50 dark:from-blue-950 dark:to-teal-950">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
                <h2 className="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-2">Daily Security Tip</h2>
                <p className="text-slate-600 dark:text-slate-400">Learn something new to stay protected</p>
            </div>
